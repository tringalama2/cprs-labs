        ...
        <div class="grid gap-6 grid-cols-1 lg:gap-8">
            <table class="text-sm border-collapse border-spacing-0">
                ...
                <tr style="font-weight: bolder">
                    ...
                    <th class="text-center border-b border-gray-500 px-2 z-20 sticky bg-gray-200 top-0" scope="col"></th>
                    <th v-for="specimen in dateTimeHeaders.value" class="text-center border-b border-gray-500 px-2 z-20 sticky bg-gray-200 top-0"
                        scope="col"
                ...
                <template v-for="(label, key, index) in labels.value">
                    <tr class="border-b border-gray-500 hover:bg-sky-200 group">
                        <th v-if="labels.value[Object.keys(labels.value)[index]]?.panel!==labels.value[Object.keys(labels.value)[index-1]]?.panel"
                            :rowspan="panels.value[label.panel]" class="font-extrabold border-r border-gray-500 group-hover:bg-white text-xl text-start ps-3 z-30 sticky bg-white left-0"
