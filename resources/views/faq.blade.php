...
@section('content')
    <div class="p-4 md:p-6 mx-auto max-w-5xl lg:max-w-7xl">
        <x-logo-and-title
            title="FAQ"
            subtitle="Frequently asked questions about using EasyCPRSLabs"
        />
            ...
            <div class="space-y-8">
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-4">
                        <strong>Yes, absolutely!</strong> We take patient privacy very seriously and have designed
                                                          EasyCPRSLabs with HIPAA-conscious principles:
                    </p>
                    <ul class="list-disc list-inside text-gray-600 leading-relaxed space-y-2 ml-4">
                        ...
                        <li><strong>Real-time processing:</strong> Lab results are processed in real-time and
                                                                   immediately returned to you
                        </li>
                        <li><strong>No tracking:</strong> We don't track or log patient information</li>
                        <li><strong>Remove identifiers:</strong> Always remove patient identifiers before using our tool
                        </li>
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 mb-4">
                        ...
                        <ol class="list-decimal list-inside text-gray-600 leading-relaxed space-y-2">
                            ...
                            <li>Use <code class="bg-gray-200 px-2 py-1 rounded text-sm">Ctrl+A</code> (or
                                <code class="bg-gray-200 px-2 py-1 rounded text-sm">Cmd+A</code> on Mac) to select all
                            </li>
                            <li>Use <code class="bg-gray-200 px-2 py-1 rounded text-sm">Ctrl+C</code> (or
                                <code class="bg-gray-200 px-2 py-1 rounded text-sm">Cmd+C</code> on Mac) to copy
                            </li>
                            <li>Paste directly into EasyCPRSLabs</li>
                        </ol>
                    </div>
                    <p class="text-gray-600 leading-relaxed">
                        Some custom or rare lab formats may not be recognized yet. If you encounter persistent issues,
                        please contact us with examples (with patient info removed) to help us improve the tool.
                    </p>
                </div>
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        <strong>Yes, EasyCPRSLabs is completely free</strong> for all healthcare providers. We built
                                                                              this tool to help improve patient care and
                                                                              reduce the time spent on administrative
                                                                              tasks. There are no hidden fees,
                                                                              subscriptions, or usage limits.
                    </p>
                    <p class="text-gray-600 leading-relaxed mt-3">
                        If you find the tool helpful, you can support us through our
                        <a href="https://www.buymeacoffee.com/tringali" target="_blank" class="text-sky-600 hover:text-sky-700 underline">sponsor
                                                                                                                                          link</a>
                        to help with hosting costs and continued development.
                    </p>
                </div>
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-4">
                        <strong>Absolutely!</strong> We're always looking to improve EasyCPRSLabs based on feedback from
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-800 mb-2">Some labs missing or in "Unparsable"
                                                                         section:</h4>
                            <ul class="list-disc list-inside text-gray-600 leading-relaxed space-y-1 ml-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6">
                        Can't find the answer you're looking for? We're here to help healthcare providers get the most
                        out of EasyCPRSLabs.
                    </p>
