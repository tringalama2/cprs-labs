            ...
            <div class="modal-content container h-auto text-left">
                ...
                <table class="text-sm border-collapse border-spacing-0">
                    ...
                    <tr>
                        ...
                        <th scope="col"
                            class="text-center border-b border-gray-500 px-2 z-20 sticky bg-gray-200 top-0">{!! $datetimeHeaders?->implode('</th><th class="text-center border-b border-gray-500 px-2 z-20 sticky bg-gray-200 top-0">') !!}</th>
                    </tr>
                    </thead>
                    @if($labs)
                        <tbody>
